...
|------|-------------|---------|
| istio-metrics | Nullplatform Istio metrics enrichment for Kubernetes applications | 1.2.0 |
| nullplatform-agent | Agent used to interact with services, scopes and telemetry inside a cluster | 2.33.1 |
| nullplatform-base | A Helm chart for deploying the nullplatform base dependencies applications using Kubernetes | 2.33.2 |
| nullplatform-cert-manager-config | A Helm chart for cert-manager configurations | 2.33.0 |
